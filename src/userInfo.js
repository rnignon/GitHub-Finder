...
function createName(name, login) {
  ...
  let name_primary = document.createElement('p');
  ...
  if (name == null) {
    ...
    user_name.appendChild(name_secondary);
  }
